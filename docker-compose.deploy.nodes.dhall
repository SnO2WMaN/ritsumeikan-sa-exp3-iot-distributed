...
let edges
    ...
    = [ { id = "ca36c3db-efbd-455b-bd59-d265af04a5cb"
        , params = { floor = +5, min = 1019.20, max = 1020.10 }
        }
      , { id = "66f06b93-ef72-42b1-9411-f309326b85d3"
        , params = { floor = +4, min = 1019.60, max = 1020.30 }
        }
      , { id = "1edb24a7-d41e-4c55-ba97-616243cd8aae"
        , params = { floor = +4, min = 1019.65, max = 1020.35 }
        }
      , { id = "14cb948d-5428-441f-a9a4-05f41ffe5271"
        , params = { floor = +3, min = 1020.10, max = 1020.60 }
        }
      , { id = "01108f00-a3ed-4c00-bde8-494217ff05b8"
        , params = { floor = +3, min = 1020.05, max = 1020.65 }
        }
      , { id = "ad405cc0-4f1a-4089-b5ef-4c12c114bff9"
        , params = { floor = +2, min = 1020.60, max = 1020.90 }
        }
      ...
      , { id = "eeb3c573-40c0-42ab-bf72-e21ae5874503"
        , params = { floor = +1, min = 1020.85, max = 1021.45 }
        }
      ]
